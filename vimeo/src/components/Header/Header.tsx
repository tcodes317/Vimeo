function Header(){
    return(
        <>
            <div className="xl:w-9/12 xs:fixed xs:z-20 xs:top-0 xs:p-2 bg-transparent xs:w-full md:w-full xs:bg-black xs:text-white">
                <div className="md:mx-5 xs:flex xs:items-center xs:justify-between">
                    <div className="xll:flex xll:items-center">
                        ...
                        <div className="xl:font-bold xs:hidden xll:relative xll:left-4 xll:block xxl:space-x-0">
                            <button className="xll:p-3 xll:pr-6 hover:bg-slate-900 transition-all xll:rounded-lg">
                                <span>Video platform</span>
                                <i className="fa fa-anlge-down ml-2 text-sm"></i>
                            </button>
                            <button className="xll:p-3 xll:pr-6 hover:bg-slate-900 transition-all xll:rounded-lg">
                                    <span>Solution</span>
                    ...
                    <div>
                        <nav className="xs:flex xs:items-center md:text-xl">
                            <a href="" hrefLang="" className="xs:font-bold">Log in</a>
                            <button className="xs:flex xs:items-center xs:mx-2 xs:p-2 xs:bg-slate-800 xs:px-3 rounded-lg xs:text-white md:pr-1 md:pl-5 md:font-bold">
                                <span>Join</span>
                                <i className="fa fa-arrow-right hidden md:block md:px-4 md:py-2 md:bg-white md:text-black md:mx-4 md:rounded-lg md:pl-4"></i>
                            </button>
